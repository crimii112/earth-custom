...
var products = (function () {
  ...
  function gfs1p0degPath(attr, type, surface, level) {
    ...
    console.log([WEATHER_PATH, dir, file].join("/"));
    ...
    wind: {
      ...
      create: function (attr) {
        return buildProduct({
          ...
          // paths: ["/data/weather/current/wind-20250725-gfs-0.25.json"],
          // paths: ["/data/weather/current/wind-20250605-gb2.json"],
          // paths: ["/data/weather/current/wind-20250605-001-gb2.json"],
          paths: ["/data/weather/current/set-grid-wind-0.1.json"],
          date: gfsDate(attr),
    ...
    temp: {
      ...
      create: function (attr) {
        return buildProduct({
          ...
          // paths: ["/data/weather/current/temp-20250725-gfs-1.0.json"],
          paths: ["/data/weather/current/temp-20250605-001-gb2.json"],
          date: gfsDate(attr),
          builder: function (file) {
            var record = file[0],
              data = record.data;
